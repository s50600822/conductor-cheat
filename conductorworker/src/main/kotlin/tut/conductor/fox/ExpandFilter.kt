...
class ExpandFilter : Worker {
    override fun getTaskDefName(): String {
        return "expand_filter_vfs_task_v1"
    }
    ...
    override fun execute(task: Task): TaskResult {
        ...
        result.outputData["transfer_assets_size"] = 63
        result.outputData["transfer_assets"] = """[
         ...
         {
            "assetId": "P273658C",
            "title": "AFL ON THE COUCH201 Episode S3",
            "startDate": "2019-09-16",
            "startTimeCode": "23:01:30.19",
            "locations": [
               {
                  "location": "playout-dr",
                  "filename": "P273658C.mxf"
               },
               {
                  "location": "k2-backup",
                  "filename": "P273658C"
