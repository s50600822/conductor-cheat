...
assert expect_spawning_time_secs > time_to_spawn, 'TIME TO CREATE WORK FLOWS MUST BE LOWER THAN [{}] secs'.format(expect_spawning_time_secs)
...
assert expect_completion_time_secs > current_elapsed, 'TIME TO COMPLETE WORKLOWS MUST BE LOWER THAN [{}] secs'.format(expect_completion_time_secs)
